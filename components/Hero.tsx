    ...
    <section className="relative h-[90vh] w-full overflow-hidden flex flex-col justify-end">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <video
          ...
          muted
          playsInline
          className="w-full h-full object-cover pointer-events-none scale-105" // Scale evita bordas brancas em alguns monitores
          poster="/54.jpg" // Imagem de carregamento
        >
          {/* ATENÇÃO: Coloque seu vídeo na pasta 'public' e atualize o src abaixo */}
          {/* Exemplo: src="/videos/cataratas-hero.mp4" */}
          <source 
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 md:pb-24">
        ...
        {/* Este é o card estilo AquaFoz na base */}
